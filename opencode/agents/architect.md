...
4. Deliver into docs — you may write anything under `docs/`, and
   `README.md`/`AGENTS.md`/`CLAUDE.md`/`WORKFLOW.md`/`WORKLOG.md`. Your
   architecture and contract documents go under `docs/architecture/` and
   `docs/contracts/`. You may write design documents but not source code.
