...
`plan` authors and assembles the docs. `plan` is read-only except `docs/**`,
`PLAN.md`, `README.md`, `AGENTS.md`, `CLAUDE.md`, `WORKFLOW.md`, and
`WORKLOG.md`. It dispatches the Plan-department specialists for the deep
