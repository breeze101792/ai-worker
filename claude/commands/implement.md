---
description: Implement a feature or fix by dispatching to the right domain engineer — firmware, Python, or web — based on the task. Use when code must be written or changed.
