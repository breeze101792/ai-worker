...
Run the recruiting pipeline from start to finish: interview me about the goal, survey the current project and the existing agents, propose a shortlist of new agents (name, role, model, permissions, location), get my one-click approval, then have the recruiter write the hire files.
